    ...
    <>
      <div className="container-fluid">
        <button
          ...
          data-bs-target="#addCourseInclude"
        ...
        <Table striped hover responsive className="border ">
          ...
          <tbody>
            <tr key={1}>
              ...
              <td> Development I don't mess around. I do this for...</td>
              ...
              <td>
                <button
                  ...
                  data-bs-toggle="modal"
                  data-bs-target="#editCourseInclude"
                >
                  <Edit />
                </button>
              </td>
